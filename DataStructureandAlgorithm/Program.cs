            ...
            while (flag)
            {
                ...
                switch (option)
                {
                    ...
                    case 8:
                        ...
                        balanceParentheses.BalanceParantheses(@"C:\Users\Suraj Sinha\OneDrive\Desktop\Bridgelabz\DataStructureAndAlgorithm\DataStructureandAlgorithm\AirthmeticExpression.txt");
                        break;
                }
            }
        }
